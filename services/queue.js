...
const BUSINESS_WORKERS = parseInt(process.env.BUSINESS_WORKERS) || 5; // Default: 2 workers for business
const FREE_PRO_WORKERS = parseInt(process.env.FREE_PRO_WORKERS) || 5; // Default: 1 worker for free/pro
